...
## How to install:
1. Save the file [steam-compatdata-symlinker](https://github.com/techmouse/steam-compatdata-symlinker-thing/blob/main/steam-compatdata-symlinker) to whatever directory you keep your personal scripts. (Example: $HOME/bin or ~/Scripts)
